...
let Exchange = (_dec = NearBindgen({
  requireInit: true
}), _dec2 = initialize(), _dec3 = call({}), _dec4 = call({}), _dec5 = view(), _dec6 = call({}), _dec7 = view(), _dec8 = call({}), _dec9 = view(), _dec10 = call({}), _dec11 = view(), _dec12 = call({}), _dec13 = view(), _dec14 = call({}), _dec15 = view(), _dec16 = call({}), _dec17 = view(), _dec18 = call({}), _dec19 = view(), _dec20 = view(), _dec21 = view(), _dec22 = call({}), _dec23 = call({
  privateFunction: true
}), _dec24 = view(), _dec25 = view(), _dec(_class = (_class2 = class Exchange {
  constructor() {
    this.owner_id = "";
  ...
  set_distribute_rate({
    ...
    this.distribute_times.set(ft_contract_id, this._get_block_timestamp_in_sec());
  ...
  exchange_token({
    ...
    const distribute_amount = this._get_distribute_amount(ft_contract_id);
    assert(distributor !== "", "Token is not exchangeable");
    assert(distribute_amount >= BigInt(exchange_amount), "Exceeded exchangeable amount");
    ...
    this.distribute_amounts.set(ft_contract_id, distribute_amount - BigInt(exchange_amount));
    this.distribute_times.set(ft_contract_id, this._get_block_timestamp_in_sec());
  ...
  _get_distribute_amount(ft_contract_id) {
    return this._get_distribute_amout(ft_contract_id) + this._get_distribute_rate(ft_contract_id) * (this._get_block_timestamp_in_sec() - this._get_distribute_time(ft_contract_id));
  }
...
}, (_applyDecoratedDescriptor(_class2.prototype, "init", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "init"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "add_oracle", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "add_oracle"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "remove_oracle", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "remove_oracle"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "is_oracle", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "is_oracle"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_fee_owner", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "set_fee_owner"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_fee_owner", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "get_fee_owner"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_distributor", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "set_distributor"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_distributor", [_dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "get_distributor"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_distribute_rate", [_dec10], Object.getOwnPropertyDescriptor(_class2.prototype, "set_distribute_rate"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_distribute_rate", [_dec11], Object.getOwnPropertyDescriptor(_class2.prototype, "get_distribute_rate"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_exchange_ratio", [_dec12], Object.getOwnPropertyDescriptor(_class2.prototype, "set_exchange_ratio"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_exchange_ratio", [_dec13], Object.getOwnPropertyDescriptor(_class2.prototype, "get_exchange_ratio"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_exchange_fee_ratio", [_dec14], Object.getOwnPropertyDescriptor(_class2.prototype, "set_exchange_fee_ratio"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_exchange_fee_ratio", [_dec15], Object.getOwnPropertyDescriptor(_class2.prototype, "get_exchange_fee_ratio"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_minimum_exchangeable_amount", [_dec16], Object.getOwnPropertyDescriptor(_class2.prototype, "set_minimum_exchangeable_amount"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_minimum_exchangeable_amount", [_dec17], Object.getOwnPropertyDescriptor(_class2.prototype, "get_minimum_exchangeable_amount"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_exchange_guard_rate", [_dec18], Object.getOwnPropertyDescriptor(_class2.prototype, "set_exchange_guard_rate"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_exchange_guard_rate", [_dec19], Object.getOwnPropertyDescriptor(_class2.prototype, "get_exchange_guard_rate"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_exchange_params", [_dec20], Object.getOwnPropertyDescriptor(_class2.prototype, "get_exchange_params"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_signature_used", [_dec21], Object.getOwnPropertyDescriptor(_class2.prototype, "get_signature_used"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "exchange_token", [_dec22], Object.getOwnPropertyDescriptor(_class2.prototype, "exchange_token"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "ft_transfer_callback", [_dec23], Object.getOwnPropertyDescriptor(_class2.prototype, "ft_transfer_callback"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_exchange_amount", [_dec24], Object.getOwnPropertyDescriptor(_class2.prototype, "get_exchange_amount"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_exchangeable_amount", [_dec25], Object.getOwnPropertyDescriptor(_class2.prototype, "get_exchangeable_amount"), _class2.prototype)), _class2)) || _class);
...
export { Exchange, add_oracle, exchange_token, ft_transfer_callback, get_distribute_rate, get_distributor, get_exchange_amount, get_exchange_fee_ratio, get_exchange_guard_rate, get_exchange_params, get_exchange_ratio, get_exchangeable_amount, get_fee_owner, get_minimum_exchangeable_amount, get_signature_used, init, is_oracle, remove_oracle, set_distribute_rate, set_distributor, set_exchange_fee_ratio, set_exchange_guard_rate, set_exchange_ratio, set_fee_owner, set_minimum_exchangeable_amount };
